...
import { Voucher, Mushroom, Garlic, Juice, Meat, Genie, Pandora, Update2, Beer, Rock, Jar} from "./Items";
...
const Debugger : OS = {//lance //bug //screwdriver
    ...
    items: [new Genie, new Pandora, new Update2, new Beer, new Jar, new Rock],
