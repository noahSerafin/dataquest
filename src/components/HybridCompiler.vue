...
<template>
  <div class="container hybrid-compiler">
    ...
    <p class="padded">Choose 2 programs to combine into 1, adding their stats and immunities together, and keeping the primary program's special move and variant name.</p>
    <!-- Slots -->
    <div class="slots">
