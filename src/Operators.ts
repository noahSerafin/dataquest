...
import { Abacus, Bank, Bubble, Cheese, Chemistry, Crystal, PetriDish, Seed, Volatile, Clippy, Notepad, StoneAge, Rune, DartBoard} from "./AdminPrograms";
...
const Debugger : OS = {
    ...
    admins: [new Crystal, new StoneAge, new Rune, new DartBoard],
    lives: 9,
